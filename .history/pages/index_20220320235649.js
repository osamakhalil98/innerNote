...
export default function Home({ headers }) {
  ...
  useEffect(() => {
    if (headers.cookie) {
      // extracting the jwt
      const token = headers.cookie.substring(4);
      console.log(
        token ==
          "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiI2MjMzY2Q2YTUwMmQ3NmEwYzRjMGU3ZWQiLCJ1c2VyTWFpbCI6Im5vb29vYkBsb2wuY29tIiwiaWF0IjoxNjQ3ODEyNjgwLCJleHAiOjE2NDc4OTkwODB9.5t47brP2AnQS0tZBVTktoJ4feDGspWrT_YG5hAElg0I"
      );
