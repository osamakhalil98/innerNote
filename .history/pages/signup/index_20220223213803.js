          ...
          <div className="grid grid-cols-1 gap-6">
            ...
            <label className="block">
              <motion.button
                ...
                type="submit"
                className="sm:w-80 justify-center  py-3 px-6 border border-transparent shadow-sm text-base font-bold rounded-md text-white bg-indigo-800 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
              >
                Sign up
              </motion.button>
            </label>
