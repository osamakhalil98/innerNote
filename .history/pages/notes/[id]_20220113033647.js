  ...
  return (
    <div className="bg-indigo-800 min-h-screen flex flex-col	justify-center items-center overflow-hidden">
      ...
      <div className="flex mb-8">
        ...
        <div className="text-center focus:text-indigo-400">
          <BsLightbulbFill
            size={`2em`}
            className="bg-violet-500 hover:bg-violet-400 active:bg-violet-600 focus:outline-none focus:ring focus:ring-violet-300 cursor-pointer mb-3 mx-4"
