...
export default function NoteId({ nnote }) {
  ...
  useEffect(() => {
    console.log("new paint happend", currentId);
    ...
    <div className="bg-indigo-800 min-h-screen flex flex-col	justify-center items-center overflow-hidden">
      ...
      <div className="flex mb-8">
        <div className="text-center">
          <HiEmojiSad
            size={`2em`}
            className="text-indigo-200 cursor-pointer hover:text-green-400  mb-3 mx-4"
        ...
        <div className="text-center">
          <AiFillLike
            size={`2em`}
            className="text-indigo-200 cursor-pointer hover:text-blue-400  mb-3 mx-4"
        ...
        <div className="text-center">
          <AiFillHeart
            size={`2em`}
            className="text-indigo-200 cursor-pointer hover:text-red-600  mb-3 mx-4"
        ...
        <div className="text-center">
          <BsLightbulbFill
            size={`2em`}
            className="text-indigo-200 cursor-pointer hover:text-yellow-500 mb-3 mx-4 focus:bg-red-400 active:bg-red-400 idea-icon"
