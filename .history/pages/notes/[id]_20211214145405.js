...
export default function NoteId({ nnote }) {
  ...
  const [ideaClicked, setIdeaClicked] = useState(1);
  const [sadCount, setSadCount] = useState(0);
  const [sadClicked, setSadClicked] = useState(1);
  const [likeCount, setLikeCount] = useState(0);
  const [likeClicked, setLikeClicked] = useState(1);
  const [loveCount, setLoveCount] = useState(0);
  const [loveClicked, setLoveClicked] = useState(1);
